        ...
        <section className="py-24 bg-white dark:bg-zinc-950 text-zinc-900 dark:text-white transition-colors duration-300">
            <div className="max-w-6xl mx-auto px-6">
                ...
                <div className="text-center max-w-xl mx-auto mb-16">
                    <span className="text-xs font-bold tracking-widest text-red-500 uppercase">Why Choose Us</span>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    {features.map((feature) => (
                        <div
                            key={feature.id}
                            className="group p-6 rounded-2xl border border-zinc-100 dark:border-zinc-900 bg-zinc-50/40 dark:bg-zinc-900/20 hover:bg-white dark:hover:bg-zinc-900/60 hover:border-zinc-200 dark:hover:border-zinc-800 transition-all duration-300 shadow-sm hover:shadow-md"
                        >
                            {/* Icon Box */}
